/**
 * Browser half of dsh-cost-track: its page inside Settings.
 *
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { zh, en }), 'dsh-cost-track: dictionaries')
