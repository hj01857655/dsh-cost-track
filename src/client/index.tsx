/**
 * Browser half of dsh-cost-track: the Cost page inside Settings.
 *
...
function CostPage() {
  ...
  if (error !== null) {
    return (
      <section>
        <p role="alert">Cost panel failed to load: {error}</p>
        <button type="button" onClick={reload}>Retry</button>
      </section>
    )
  }
  if (html === null) return <p aria-live="polite">Loading the Cost panel…</p>
