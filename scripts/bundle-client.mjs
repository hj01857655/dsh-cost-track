 ...
 * reports as "loaded without registering 'dsh-cost-track' via __ModuleLoader__.load".
 *
...
await build({
  ...
  banner: {
    ...
    js: 'window.__ModuleLoader__.load({ id: "dsh-cost-track", factory: (require) => {'
